// Client portal calendar: renders an interactive calendar of the client's bookings by venue.
document.addEventListener('DOMContentLoaded', initClientCalendar);
        ...
        async function initClientCalendar() {
            ...
            let bookings = [];
            try {
                const response = await BookingApi.getClientBookings(clientId, 1, 1000);
